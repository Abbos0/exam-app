      ...
      <form className='absolute  inset-0 flex items-center justify-center '>
          <div className=' backdrop-blur border-solid border-[1px] rounded-[30px]  w-[400px] h-[400px] text-white'>
            ...
            <div className='flex flex-col items-center px-[50px] gap-3 py-10'>
              <input type='text' className='tracking-wider capitalize w-full font-medium text-white text-[20px] px-3 outline-none bg-transparent border-solid border-white border-b-[3px] ' placeholder='Name' />
              <input type='text' className='tracking-wider capitalize w-full font-medium text-white text-[20px] px-3 outline-none bg-transparent border-solid border-white border-b-[3px] ' placeholder='Surname' />
